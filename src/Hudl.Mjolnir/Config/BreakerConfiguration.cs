namespace Hudl.Mjolnir.Config
{
    public class BreakerConfiguration
    {
        ...
        /// </summary>
        public virtual long WindowMillis { get; set; }
        ...
        /// </summary>
        public virtual long TrippedDurationMillis { get; set; }
        ...
        /// </summary>
        public virtual bool ForceTripped { get; set; }
        ...
        /// fixed) are true, the Breaker will be tripped.
        /// </summary>
        public virtual bool ForceFixed { get; set; }

        public virtual long SnapshotTtlMillis { get; set; }
    }
}